...
import com.arash.neshan.test2.utils.parcelable
    ...
    private inner class ForegroundBroadcastReceiver : BroadcastReceiver() {
        ...
        override fun onReceive(context: Context, intent: Intent) {
            ...
            if (intent.hasExtra(ForegroundLocationService.EXTRA_LOCATION)) {
                val location =
                    intent.parcelable<Location>(ForegroundLocationService.EXTRA_LOCATION)
                ...
                val location =
                    intent.parcelable<Location>(ForegroundLocationService.EXTRA_LAST_LOCATION)
